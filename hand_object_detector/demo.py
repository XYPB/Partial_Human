...
if __name__ == '__main__':
    ...
    load_name = os.path.join(model_dir, 'faster_rcnn_{}_{}_{}.pth'.format(
        ...
        while (num_images >= 0):
            ...
            for i in range(len(args.shift)):
                ...
                rois, cls_prob, bbox_pred, \
                    ...
                    rois_label, loss_list = fasterRCNN(
                ...
                for j in xrange(1, len(pascal_classes)):
                    ...
                    if inds.numel() > 0:
                        ...
                        cls_dets = torch.cat((cls_boxes, cls_scores.unsqueeze(
                            1), contact_indices[inds], offset_vector.squeeze(0)[inds], lr[inds]), 1)
                ...
                if vis:
                    ...
                    newPic['bboxes'] = [] if hand_dets is None else [
                        singHand[0:4].tolist() for singHand in hand_dets]
                    newPic['lr'] = [] if hand_dets is None else [
                        int(singHand[-1]) for singHand in hand_dets]
